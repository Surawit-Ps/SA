...
// เพิ่มฟังก์ชันสำหรับการชำระเงิน
async function CreatePayment(data: any) {
    return await axios
        .post(`${apiUrl}/payment/QRcodePayment`, data, requestOptions)
        .then((res) => res)
        .catch((e) => e.response);
}

// เพิ่มฟังก์ชันสำหรับการจัดอันดับ
async function CreateRating(data: any) {
    return await axios
        .post(`${apiUrl}/Rating`, data, requestOptions)
        .then((res) => res)
        .catch((e) => e.response);
}

async function GetWagesByWorkID(workID: string) {
    return await axios
        .get(`${apiUrl}/works/${workID}/track`, requestOptions)
        .then((res) => res)
        .catch((e) => e.response);
}
