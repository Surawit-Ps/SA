...
func main() {
    ...
    r.PUT("/works/bookings/:id", booking.UpdateBookingStatus)
    ...
    authorized.GET("/works/:workID/track", work.GetWagesByWorkID)
    ...
    authorized.GET("/payment/QRcodePayment", payment.CreatePayment)
    authorized.GET("/payment/DebitCardPayment", payment.CreatePayment)
